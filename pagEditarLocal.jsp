...
<head>
  <title>UTPhone | Editar Local</title>
...
<%
    local l = (local)request.getAttribute("dato");
%>
<body>
  <div class="container">
    <div class="row">
      <div class="menu" style="overflow: scroll">
        ...
        <div class="dahboard-menuitem">
          <div class="dahboard-menutop">
            ...
            <a class="dahboard-menu1" href="pagIngresoLocal.jsp">
            ...
            <div class="frame40251-frame40248">
              <div class="table_header">
                <span class="frame40251-text014 HeaderH1">
                  <span>Editar Local con ID: <%=l.getId()%></span>
                </span>
              </div>
            </div>

            <div class="frame40251-frame40248">
              <form action="controlLocal">
                <div class="signinformwhite-input">
                  <div style="display:flex; flex-direction: column; margin-top: 10px;">
                    ...
                    <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                           type="text" name="ciudad" value="<%=l.getCiudad()%>"/>
                  </div>
                  <div style="display:flex; flex-direction: column; margin-top: 10px;">
                    <span>
                    ...
                    <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                      type="text" name="depart" value="<%=l.getDepartamento()%>"/>
                  </div>
                  <div style="display:flex; flex-direction: column; margin-top: 10px;">
                    <span>
                      <span>Dirección</span>
                    ...
                    <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                      type="text" name="direc" value="<%=l.getDireccion()%>"/>
                  </div>
                  <div style="display:flex; flex-direction: column; margin-top: 10px;">
                    <span>
                      <span>Teléfono</span>
                    ...
                    <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                           type="number" name="tele" value="<%=l.getTelefono()%>"/>
                  </div>
                  ...
                  <button class="button signinformwhite-buttons">
                    <span class="signinformwhite-text14">
                      ...
                      <input type="submit" class="signinformwhite-text14" value="Actualizar datos de Local" name="b1"
