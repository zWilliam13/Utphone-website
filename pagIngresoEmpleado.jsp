                        ...
                        <div class="signinformwhite-input">
                                ...
                                name="idlocal" >
                                    <%
                                        ...
                                        for (local c : obj.lisLocal()) {                
                                          out.println("<option value='"+c.getId()+"'>"+c.getId()+" "+c.getDireccion()+" "+c.getCiudad());
                                                                   }
                                    %>
                                </select>
                              </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            ...
                            <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                                   type="text" name="ap_pate" placeholder="Ingrese el apellido paterno..." required/>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
                            ...
                            <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                                   type="text" name="ap_mate" placeholder="Ingrese el apellido materno..." required/>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
                              <span>Nombres</span>
                            ...
                            <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                                   type="text" name="nombre" placeholder="Ingrese sus nombres..." required/>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
                            ...
                            <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                              type="text" name="correo" placeholder="name@company.com" required/>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
                              <span>Tipo de documento</span>
                              <br>
                              <input style="border-radius: 10px; padding: 10px; margin: 10px 20px;" type="radio" name="tipodoc" value="1"/>DNI
                              <input style="border-radius: 10px; padding: 10px; margin: 10px 20px;"type="radio" name="tipodoc" value="2"/>Pasaporte
                            </span>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
                            ...
                            <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                              type="number" name="numdoc" placeholder="########" required/>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
                              <span>Usuario</span>
                            ...
                            <input style="border: 1px solid rgba(0,0,0,0.2); border-radius: 10px; padding: 10px; margin: 10px 0;font-size:14px;"
                                   type="text" name="idemp" placeholder="Ingrese su nombre de usuario..." required/>
                          </div>
                          <div style="display:flex; flex-direction: column; margin-top: 10px;">
                            <span>
