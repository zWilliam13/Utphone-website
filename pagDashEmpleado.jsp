...
<%@page import="modelo.cantEmp"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="DAO.DAOgraf"%>
<!DOCTYPE html>
<!DOCTYPE html>
<html lang="es">
  <head>
    <title>UTPhone | Dashboard Empleado</title>
        ...
        <div class="row">
            ...
            <div class="dahboard-menuitem" >
              <div class="dahboard-menutop">
                ...
                <a class="dahboard-menu1" href="pagDashEmpleado.jsp">
                  <img alt="MenuDashboardI188" src="imgPag/menudashboardi188-rb7.svg"/>
                  ...
                  <div class="frame40251-header1">
                      ...
                      <div class="table_header">
                        ...
                        <section>
                          <div class="input_search">
                            <input type="text" name="txtnom" id="txtnom" value="" placeholder="Buscar por nombre...">
                            <i  class="material-symbols-outlined">search</i>
                          </div>
                        </section>
                        <a href="pagIngresoEmpleado.jsp"><button>Crear nuevo</button></a>
                      </div>
                    </div>
                    ...
                    <section id="tablares">  
                      ...
                      <%
                            ...
                            String label="",data="";
                            for(cantEmp x:obj.lisEmpleado()){
                            label += "'"+x.getIdLocal()+"',";
                            data += x.getNumEmp()+",";
                             }
                             if(obj.lisEmpleado().size()>0){
                             label=label.substring(0, label.length()-1);
                             data=data.substring(0, data.length()-1);
                          }
                       %>
                    <div class="frame40251-frame40248">
                        <h2 style="text-align: center">Grafico de Cantidad de empleados por local</h2>
                        <br>
