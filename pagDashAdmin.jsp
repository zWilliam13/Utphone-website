...
<html lang="es">
  <head>
    <title>UTPhone | Dashboard Administrador</title>
    ...
    <script src="js/filtrarAdmin.js" type="text/javascript"></script>
        ...
        <div class="row">
            ...
            <div class="dahboard-menuitem" >
              <div class="dahboard-menutop">
                ...
                <a class="dahboard-menu1" href="pagDashAdmin.jsp">
                  <img alt="MenuDashboardI188" src="imgPag/menudashboardi188-rb7.svg"/>
                      ...
                      <div class="table_header">
                        ...
                        <section>
                          <div class="input_search">
                            <input type="text" name="txtnom" id="txtnom" value="" placeholder="Buscar...">
                            <i  class="material-symbols-outlined">search</i>
                          </div>
                        </section>
                        <a href="regAdmin.jsp"><button>Crear nuevo</button></a>
                      </div>
                    </div>
